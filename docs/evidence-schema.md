...
| artifacts.json | `{artifacts:[{id, kind:"skill" or "agent", source, path, activation_count, body}]}` — the ≤10 most-activated user-owned skills + any-source agents, bodies truncated to 8000 chars |
